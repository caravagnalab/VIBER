...
until we develop an automatic installer for [mvbmm](https://github.com/caravagn/mvbmm). Once installed just load the package
...
`mvbmm` implements 2 possible filters which are available in function `choose_clusters`.
