...
[![R-CMD-check](https://github.com/caravagn/VIBER/workflows/R-CMD-check/badge.svg)](https://github.com/caravagn/VIBER/actions)
<!-- badges: end -->
...
`VIBER` is part of the `evoverse`, a [set of R packages](https://caravagn.github.io/evoverse) to implement Cancer Evolution analyses.
